 ...
 * 
 * To view the data:
 * 1. Visit: https://lexirain.vercel.app/api/dashboard
...
export default async function handler(
  ...
  try {
    ...
    // Store events (for viewing via /api/view-analytics)
